...
# Optionally bundle the sample DuckDB (generated by scripts/seed_sample_db.py)
SAMPLE_DB = HERE / "data" / "sample.duckdb"
...
a = Analysis(
    ...
    ] + ([(str(SAMPLE_DB), "data")] if SAMPLE_DB.exists() else []) + extra_datas,
    hiddenimports=[
        # Core
        "duckdb",
        "numpy",
